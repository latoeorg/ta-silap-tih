<template>
  <div class="student-dashboard">
    ...
    <VCard class="welcome-header" color="primary" variant="elevated">
      <VCardText>
        <div class="d-flex align-center gap-4">
          <VIcon icon="tabler-school" size="48" color="white" />
          <div>
    ...
    <VAlert type="info" variant="tonal" class="mt-4" closable>
      <template #prepend>
    ...
    <VRow class="mt-6">
      ...
      <VCol cols="12" md="8">
        <VCard class="profile-data-card">
          <VCardTitle
            class="d-flex align-center justify-space-between bg-primary py-4"
          >
            ...
            <VRow>
              ...
              <VCol cols="12" sm="6" md="4">
                <div class="profile-field">
                  ...
                  <p>
                    {{
                      user?.studentProfile?.birthDate
                        ? formatDate(user.studentProfile.birthDate)
                        : "Belum diisi"
                    }}
                  </p>
                </div>
          ...
          <VRow>
            <VCol cols="12" md="6">
              <div class="guide-item">
                ...
                <strong>Lengkapi Profil:</strong> Pastikan data diri Anda
                lengkap dan terkini
              </div>

              <div class="guide-item">
                <VIcon icon="tabler-book-2" color="primary" class="me-2" />
                <strong>Akses Materi:</strong> Unduh materi pembelajaran dari
                dosen
              </div>

              <div class="guide-item">
                <VIcon icon="tabler-calendar" color="primary" class="me-2" />
                <strong>Jadwal Kuliah:</strong> Lihat jadwal kuliah dan ujian
                Anda
              </div>
            </VCol>
            ...
            <VCol cols="12" md="6">
              <div class="guide-item">
                ...
                <strong>Nilai:</strong> Pantau nilai dan IPK Anda secara
                real-time
              </div>

              <div class="guide-item">
                <VIcon icon="tabler-file-text" color="primary" class="me-2" />
                <strong>Dokumen:</strong> Ajukan dan unduh berbagai dokumen
                akademik
              </div>
