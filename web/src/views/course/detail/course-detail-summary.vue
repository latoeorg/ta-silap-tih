      ...
      <VCol cols="12" md="8">
        <VCard>
          ...
          <VCardText>
            ...
            <div v-else-if="course" class="pa-2">
              <VList density="compact">
                ...
                <VListItem>
                  <template #prepend>
                    <VIcon icon="tabler-book-2" class="me-3" color="info" />
                  </template>
                  <VListItemTitle class="font-weight-medium">
                    Mata Pelajaran
                  </VListItemTitle>
                ...
                <VListItem>
                  <template #prepend>
                    <VIcon icon="tabler-user" class="me-3" color="success" />
                  </template>
                  <VListItemTitle class="font-weight-medium">
                    Guru Pengajar
                  </VListItemTitle>
                ...
                <VListItem>
                  <template #prepend>
                    <VIcon icon="tabler-edit" class="me-3" color="secondary" />
                  </template>
                  <VListItemTitle class="font-weight-medium">
                    Terakhir Diperbarui
                  </VListItemTitle>
          ...
          <VCardText>
            ...
            <div v-else>
              <div class="d-flex justify-space-between align-center mb-4">
                <div class="text-body-2 text-medium-emphasis">Total Siswa</div>
              ...
              <div class="d-flex justify-space-between align-center mb-4">
                <div class="text-body-2 text-medium-emphasis">Total Nilai</div>
...
const fetchStatistics = async () => {
  try {
    ...
    statistics.value.attendanceRate =
...
const generateRecentActivities = (attendanceRecords, gradeRecords) => {
  ...
  recentAttendance.forEach((record) => {
    activities.push({
      ...
      description: `${record.student?.name || "Siswa"} - ${getStatusText(
        record.status
      )}`,
  ...
  recentGrades.forEach((record) => {
    activities.push({
      id: `grade-${record.id}`,
      title: "Nilai Diinput",
      description: `${record.student?.name || "Siswa"} - ${getExamTypeText(
        record.examType
      )} (${record.grade})`,
