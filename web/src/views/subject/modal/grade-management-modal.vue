<template>
  ...
  >
    <VCard>
      ...
      <VCardText>
        <div
          v-if="selectedGrade && selectedStudent"
          class="pa-2"
        >
          <!-- Student info -->
          ...
          >
            ...
            <VCard
              variant="flat"
              class="mb-4 pa-3 bg-surface-100 rounded"
            >
                ...
                <div class="component-bars">
                  ...
                  >
                    <div class="d-flex justify-space-between mb-1">
                      <span class="text-caption">{{ comp.score }} /
...
watch(gradeForm.value.examType, async newExamType => {
  console.log("Watch triggered with exam type:", newExamType)
  if (newExamType) {
    await loadGradeComponentDefinitions()
    await loadGrades()
